...
class PostDetailsPage extends StatefulWidget {
  ...
  @override
  _PostDetailsPageState createState() => _PostDetailsPageState(this.title,
      this.image, this.date, this.time, this.description, this.author);
}

class _PostDetailsPageState extends State<PostDetailsPage> {
  _PostDetailsPageState(this.title, this.image, this.date, this.time,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${author ?? "hantu"}'s post"),
      ),
      body: Column(
        ...
        children: <Widget>[
          ...
          Text(
            "${time ?? "Unknown Time"}, ${date ?? "Unknown date"} ",
